...
class TipTo extends SubViewElement implements DefaultSubViewElement {
  ...
  update(state: ViewSliderState) {
    ...
    if (this.memo('Mount/Unmount component', [tips, isRange])) {
    ...
    if (this.memo('Position and value data', [to, horizontal, isRange, invert, handleSplit, tips])) {
    ...
    if (this.memo('Class modifiers data', [to.pressedLast, to.movingNow, horizontal, tips, isRange])) {
